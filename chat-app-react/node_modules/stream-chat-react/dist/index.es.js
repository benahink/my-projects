...
function (_React$Component) {
  ...
  _createClass(MessageActionsBox, [{
    ...
    value: function render() {
      ...
      var messageActions = Message.getMessageActions();
      return React__default.createElement("div", {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (_this.props.message.status === 'sending') {
        ...
        return React__default.createElement("span", {
          ...
          size: 15
        }), message.readBy.length - 1 > 1 && React__default.createElement("span", {
  ...
  _createClass(MessageSimple, [{
    ...
    value: function renderOptions() {
      ...
      if (this.isMine()) {
        return React__default.createElement("div", {
        ...
        }, this.renderMessageActions(), !this.props.threadList && this.props.channelConfig.replies && React__default.createElement("div", {
          ...
          fillRule: "evenodd"
        }))), this.props.channelConfig.reactions && React__default.createElement("div", {
        ...
        return React__default.createElement("div", {
          ...
          d: "M11.108 8.05a.496.496 0 0 1 .212.667C10.581 10.147 8.886 11 7 11c-1.933 0-3.673-.882-4.33-2.302a.497.497 0 0 1 .9-.417C4.068 9.357 5.446 10 7 10c1.519 0 2.869-.633 3.44-1.738a.495.495 0 0 1 .668-.212zm.792-1.826a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.298 0-.431.168-.54.307A.534.534 0 0 1 9.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zm-7 0a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.299 0-.432.168-.54.307A.533.533 0 0 1 2.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zM7 0a7 7 0 1 1 0 14A7 7 0 0 1 7 0zm4.243 11.243A5.96 5.96 0 0 0 13 7a5.96 5.96 0 0 0-1.757-4.243A5.96 5.96 0 0 0 7 1a5.96 5.96 0 0 0-4.243 1.757A5.96 5.96 0 0 0 1 7a5.96 5.96 0 0 0 1.757 4.243A5.96 5.96 0 0 0 7 13a5.96 5.96 0 0 0 4.243-1.757z",
          fillRule: "evenodd"
        }))), !this.props.threadList && this.props.channelConfig.replies && React__default.createElement("div", {
          onClick: this.props.openThread,
          className: "str-chat__message-simple__actions__action str-chat__message-simple__actions__action--thread"
        }, React__default.createElement("svg", {
          width: "14",
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, this.props.editing && React__default.createElement(Modal, {
        ...
        className: "str-chat__simple-message--error-message"
      }, "Message Failed \xB7 Click to try again"), this.props.unsafeHTML ? React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
...
function (_PureComponent2) {
  ...
  function ChannelInner(props) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "renderLoading", function () {
...
function (_PureComponent) {
  ...
  _createClass(MessageCommerce, [{
    ...
    value: function render() {
      ...
      }, "Error \xB7 Unsent"), this.props.unsafeHTML ? React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
      }) : renderText(message), hasReactions > 0 && !this.state.showDetailedReactions && React__default.createElement(ReactionsList, {
  ...
  _createClass(MessageLivestream, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        ...
        messageList: this.props.messageListRect,
        ref: this.reactionSelectorRef
      }), !this.props.initialMessage && message.type !== 'error' && message.type !== 'system' && message.type !== 'ephemeral' && message.status !== 'failed' && message.status !== 'sending' && React__default.createElement("div", {
        className: "str-chat__message-livestream-actions"
      }, React__default.createElement("span", {
        className: "str-chat__message-livestream-time"
      }, moment(message.created_at).format('h:mmA')), this.props.channelConfig && this.props.channelConfig.reactions && React__default.createElement("span", {
        onClick: this.onClickReactionsAction
      }, React__default.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: reactionSvg
        }
      })), !this.props.threadList && this.props.channelConfig && this.props.channelConfig.replies && React__default.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: threadSvg
        },
        onClick: function onClick(e) {
      ...
      }), this.props.Message.getMessageActions().length > 0 && React__default.createElement("span", {
        ...
        onMouseOver: this.props.onMentionsHoverMessage,
        onClick: this.props.onMentionsClickMessage
      }, message.type !== 'error' && message.status !== 'failed' && !this.props.unsafeHTML && renderText(message), message.type !== 'error' && message.status !== 'failed' && this.props.unsafeHTML && React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
...
function (_PureComponent) {
  ...
  _createClass(MessageTeam, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
      ...
      }, !this.props.initialMessage && message.status !== 'sending' && message.status !== 'failed' && message.type !== 'system' && message.type !== 'ephemeral' && message.type !== 'error' && React__default.createElement("div", {
        ...
        ref: this.reactionSelectorRef
      }), this.props.channelConfig && this.props.channelConfig.reactions && React__default.createElement("span", {
        title: "Reactions",
        dangerouslySetInnerHTML: {
        ...
        onMouseOver: this.props.onMentionsHoverMessage,
        onClick: this.props.onMentionsClickMessage
      }, this.props.unsafeHTML ? React__default.createElement("div", {
        dangerouslySetInnerHTML: {
          __html: message.html
        }
