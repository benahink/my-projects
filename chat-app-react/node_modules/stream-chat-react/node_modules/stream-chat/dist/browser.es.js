...
function () {
  ...
  _createClass(Channel, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee17(options) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee19(parent_id, options) {
        var data;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee20(message_id, options) {
        var data;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee23(targetUserID) {
...
function () {
  ...
  _createClass(StreamChat, [{
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return this.post(this.baseURL + '/check_push', _objectSpread({
                  user_id: userID
                }, data.messageID ? {
    ...
    value: function disconnect() {
      ...
      var _arr2 = Object.values(this.activeChannels);
    ...
    */
    value: function _updateUserReferences(user) {
      ...
      for (var _i4 = 0; _i4 < refs.length; _i4++) {
        var channelID = refs[_i4];
    ...
    value: function () {
      ...
      _regeneratorRuntime.mark(function _callee13(filterConditions, sort, options) {
        var sortFields, _arr3, _i5, _arr3$_i, k, v, defaultOptions, data;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                for (_i5 = 0; _i5 < _arr3.length; _i5++) {
                  _arr3$_i = _slicedToArray(_arr3[_i5], 2), k = _arr3$_i[0], v = _arr3$_i[1];
                  sortFields.push({
                    field: k,
                    direction: v
                  });
    ...
    value: function () {
      ...
      _regeneratorRuntime.mark(function _callee14(filterConditions) {
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                sortFields = [];
                _arr4 = Object.entries(sort);

                for (_i6 = 0; _i6 < _arr4.length; _i6++) {
                  _arr4$_i = _slicedToArray(_arr4[_i6], 2), k = _arr4$_i[0], v = _arr4$_i[1];
                  sortFields.push({
                    field: k,
                    direction: v
                  });
        ...
        }, _callee14, this, [[17, 21, 25, 33], [26,, 28, 32], [36, 40, 44, 52], [45,, 47, 51]]);
      }));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee20(users) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee21(userID, params) {
        return _regeneratorRuntime.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              case 0:
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee22(userID, options) {
        return _regeneratorRuntime.wrap(function _callee22$(_context22) {
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee23(userID, options) {
        return _regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
    ...
    value: function () {
      var _unbanUser = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee26(targetUserID, options) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee27(targetID) {
        var userID,
            _args27 = arguments;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee28(targetID) {
        var userID,
            _args28 = arguments;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee29(messageID) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee30(userID) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee34(message, userId) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee35(messageID) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee36(messageID) {
    ...
    value: function _startCleaning() {
      ...
      this.cleaningIntervalRef = setInterval(function () {
        ...
        var _arr5 = Object.values(that.activeChannels);

        for (var _i7 = 0; _i7 < _arr5.length; _i7++) {
          var channel = _arr5[_i7];
          channel.clean();
        }
      }, 500);
    }
